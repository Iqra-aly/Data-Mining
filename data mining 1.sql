create schema Online_Retail;
use Online_Retail;
select * from Online_Retail;
select * from online_retail;

--  2:to distribute the order value first calculate the order value and then distribute
...
-- 5 products most commonly purchased together
...
sum(Quantity * UnitPrice) as QuaterlySales
from online_retail
